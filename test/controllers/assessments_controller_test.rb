...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { assessment_master_id: @assessment.assessment_master_id, marks: @assessment.marks, student_id: @assessment.student_id, subject_id: @assessment.subject_id, teacher_id: @assessment.teacher_id } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { assessment_master_id: @assessment.assessment_master_id, marks: @assessment.marks, student_id: @assessment.student_id, subject_id: @assessment.subject_id, teacher_id: @assessment.teacher_id } }
