...
class StudentAttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_attendance" do
    assert_difference('StudentAttendance.count') do
      post student_attendances_url, params: { student_attendance: { class_id: @student_attendance.class_id, present_status: @student_attendance.present_status, student_id: @student_attendance.student_id } }
    end
  ...
  test "should update student_attendance" do
    patch student_attendance_url(@student_attendance), params: { student_attendance: { class_id: @student_attendance.class_id, present_status: @student_attendance.present_status, student_id: @student_attendance.student_id } }
